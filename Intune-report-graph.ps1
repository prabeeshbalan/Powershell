...
$appid = 'enter your app id' # App ID of the App Registration
$tenantid = 'enter your tenant id' # Tenant ID of your EntraID
$secret = 'enter secret if any' # Secret of the App Registration
